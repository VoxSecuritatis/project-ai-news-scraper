...
**AI News Scraper** is an automated content aggregation platform that monitors AI, machine learning, and data science news from 10 curated sources including blogs, RSS feeds, and YouTube channels. The system uses OpenAI's GPT-4o-mini to generate intelligent summaries with key insights, categorizes content automatically, and deduplicates articles across sources. Every day at 7:30 AM, subscribers receive a beautifully formatted email digest featuring the most relevant AI news with summaries, bullets, and explanations of why each article matters. Built with ChatGPT, Cursor, FastAPI, Next.js, PostgreSQL, and Docker, it provides a modern admin dashboard for source management and runs entirely self-hosted.  It is a full-stack application consisting of a web GUI front-end, an application layer, and a Postrgres database in the container.
